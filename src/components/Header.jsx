  ...
  return (
    <header className="bg-white shadow-md fixed top-0 left-0 w-full z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-3">
        <Link to="/" className="text-[12px] sm:text-2xl  font-bold text-pink-600">
          Daniel — Art
        </Link>

        <nav className="flex-1 flex justify-center space-x-8 text-[12px] sm:text-2xl">
          <Link
            to="/"
        ...
        >
            <FaCartArrowDown className="w-5 h-5 sm:w-8 sm:h-8"/>
          {cartCount > 0 && (
